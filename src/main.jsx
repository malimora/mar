...
function OverviewCard({ regularState, prnState, lastRegular, lastTramadol, paracetamolToday, settings, effectiveNow, onOpen }) {
  ...
  const prnLine = prnState.available ? "As-needed Tramadol is available now if pain requires it." : `As-needed Tramadol becomes available in ${formatRelative(prnState.availableAt.getTime() - effectiveNow.getTime())}.`;
